            ...
            <div className="w-full max-w-md bg-card rounded-2xl border border-border p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <Input id="email" type="email" placeholder="admin@email.com" value={email} onChange={(e) => setEmail(e.target.value)} className="mt-1.5 bg-secondary/50" disabled={loading} />
                    </div>
                    <div>
                ...
                <p className="text-center text-sm text-muted-foreground mt-6">
                    ...
                    <Link to="/admin/signup" className="text-primary font-medium hover:underline">Create Account</Link>
                </p>
                <p className="text-center text-sm text-muted-foreground mt-3">
                    <Link to="/login" className="text-muted-foreground hover:text-foreground hover:underline">← Back to Student Login</Link>
                </p>
            </div>
        </div>
    );
